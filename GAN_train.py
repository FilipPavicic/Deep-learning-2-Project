# -*- coding: utf-8 -*-
"""
Created on Mon Dec 26 15:03:59 2022
...
parser.add_argument('--age_classifier_path', type=str, help='directory of age classification model', default='./checkpoint/pretrain_alexnet/saved_parameters/epoch_20_iter_0.pth')
...
def main():
    ...
    dict_state = torch.load('C:/Users/Frane/Desktop/DIPLOMSKI/peta/duboko_ucenje2/projekt/checkpoint/IPCGANS/2022-12-26_18-10-32/saved_parameters/gepoch_2_iter_3000.pth')
    model.load_generator_state_dict(dict_state)
